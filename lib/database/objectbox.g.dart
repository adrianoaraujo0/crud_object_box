...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 6625702506428013999),
      name: 'Tarefa',
      lastPropertyId: const IdUid(2, 4929467952144715749),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 3340711080718231889),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 4929467952144715749),
            name: 'nome',
            type: 9,
            flags: 0)
      ],
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(1, 6625702506428013999),
...
class Tarefa_ {
  ...
  /// see [Tarefa.nome]
  static final nome = QueryStringProperty<Tarefa>(_entities[0].properties[1]);
}
